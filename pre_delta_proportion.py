# -*- coding: utf-8 -*-
"""
Created on Thu Apr  4 14:45:48 2024
...
def subtract_rasters(raster1_folder, raster2, output_folder):
    ...
    for raster1 in raster1_files:
        ...
        for i in range(1, bandCount + 1):
            ...
            # 如果band2为0，则用1e-10替换，避免除以0
            band2_safe = np.where(band2 == 0, 1e-10, band2)
            result_band = (band1 - band2_safe) / band2_safe * 100
...
raster2 = r'F:\Jingyi\Climate\WorldClim\Past\China\pre\wc2.1_30s_prec_merged_China.tif'
output_folder = r'F:\Jingyi\Climate\Prediction\worldclim_delta\pre'
